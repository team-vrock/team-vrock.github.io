            ...
            function SimpleJekyllSearch() {
                ...
                var self = this,
                    ...
                    opt = {
                        ...
                        searchResultTemplate: '<div class="user-projects"> <div class="images-left"> <img alt="mountains" src="{image}" /> </div> <div class="contents-right"> <h3>{title}</h3> <p>{excerpt}</p> <a class="project-link" href="{url}">Check it out</a> </div> </div>',
